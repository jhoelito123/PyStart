...
const Certificate: React.FC<CertificateProps> = ({
  ...
  return (
    <div
      className="w-full max-w-4xl mx-auto bg-white relative overflow-hidden"
      style={{ aspectRatio: '11/8.5' }}
    >
      <div
        className="absolute inset-0"
        style={{ backgroundColor: '#F9F6F3', border: 'solid' }}
      ></div>
        ...
        <div className="flex-1 p-8 flex flex-col">
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="text-black font-bold text-xl">
              <img
                className="h-12 drop-shadow-lg"
                src="..\public\icons\logoDevmente.png"
                alt="Logon't"
              />
            </div>
          </div>
          ...
          <div className="flex-1 space-y-3.5 text-lg text-black">
            <div className="flex items-center">
              <span>
                Se otorga el presente certificado de aprobación al estudiante:
              </span>
            </div>
            <div className="flex items-center">
          ...
          <div className="mt-7 flex justify-between">
            <div className="text-center">
              ...
              />
              <div className="text-sm font-medium border-t-2 border-black">
                {data.deanName}
              </div>
            ...
            <div className="text-center">
              ...
              />
              <div className="text-sm font-medium border-t-2 border-black">
                {data.vicePresidentName}
              </div>
              <div className="text-xs text-gray-600">
                {data.vicePresidentTitle}
              </div>
            </div>
          </div>
