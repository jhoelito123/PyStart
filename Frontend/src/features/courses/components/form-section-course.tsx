          ...
          <div className="flex flex-col space-x-9">
            ...
            <div className='grid grid-cols-1 w-full'>
              <TextArea
                ...
                register={register}
                validationRules={{
                  required: 'La descripción de la sección del curso es obligatoria',
                  minLength: {
                    value: 20,
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-9 mb-2">
              <div className='grid grid-cols-1'>
                <TextArea
                  ...
                  register={register}
                  validationRules={{
                    required: 'La explicación de la sección del curso es obligatoria',
                    minLength: {
                      value: 20,
                ...
                <TextArea
                  ...
                  register={register}
                  validationRules={{
                    required: 'La instrucción del ejecutor de código es obligatoria',
                    minLength: {
                      value: 10,
